...
This project is indexed by GitNexus as **workout** (1944 symbols, 2836 relationships, 12 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
