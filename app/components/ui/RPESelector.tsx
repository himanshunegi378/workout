                ...
                {RPE_OPTIONS.map((rpe) => {
                    ...
                    return (
                        <button
                            ...
                            className={`shrink-0 w-12 h-12 rounded-xl border flex flex-col items-center justify-center transition-all duration-200 active:scale-90
                                ${isSelected
                                    ? "bg-indigo-500 text-white border-transparent shadow-lg shadow-indigo-500/20"
                                    : "bg-muted/50 text-muted-foreground border-border/50 hover:border-accent/40"
                                }`}
                        >
                            <span className="text-lg font-display font-bold">{rpe}</span>
