...
export function LogSetDrawer({
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col justify-end">
            ...
            {/* Drawer */}
            <div className="relative w-full bg-card border-t border-border rounded-t-3xl p-6 pb-safe animate-slide-up shadow-2xl">
                ...
                <Button
                    ...
                    onClick={onSave}
                    disabled={isSaving || !reps} // Weight is optional for bodyweight ex
                >
